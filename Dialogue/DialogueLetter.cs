...
namespace PlayerDialogue
{
    public class DialogueLetter : MonoBehaviour
    {
        ...
        [SerializeField]
        private GameObject letterTextItem;
        ...
        void Update()
        {
            if (Input.GetButtonDown("Interact") && dialogueActived == true && canContinueText == true)
            {
                ...
                if (step >= speaker.Length)
                {
                    ...
                    letterTextItem.SetActive(false);
                ...
                else
                {
                    ...
                    letterText.text = letterWords[step];
                    dialogueCanvas.SetActive(true);
                    letterTextItem.SetActive(true);
